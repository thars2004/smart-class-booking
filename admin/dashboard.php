...
<html lang="en">
    <head>
        ...
        <title>Admin Dashboard | SSB College</title>
            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid px-4">
                        ...
                        <div class="row">
<?php
$query=mysqli_query($con,"select id from tblbook");
$totalusers=mysqli_num_rows($query);
?>

                            <div class="col-xl-3 col-md-6">
                                <div class="card bg-primary text-white mb-4">
                                    <div class="card-body">Total Utilized Hour 
...
<?php
$query1=mysqli_query($con,"select id from tblbook where date(posting_date)=CURRENT_DATE()-1");
$yesterdayregusers=mysqli_num_rows($query1);
?>

                            <div class="col-xl-3 col-md-6">
                                <div class="card bg-warning text-white mb-4">
                                    <div class="card-body">Yesterday Utilized Hour 
...
<?php
$query2=mysqli_query($con,"select id from tblbook where date(posting_date)>=now() - INTERVAL 7 day");
$last7daysregusers=mysqli_num_rows($query2);
?>

                            <div class="col-xl-3 col-md-6">
                                <div class="card bg-success text-white mb-4">
                                    <div class="card-body"> Utilized Hour in Last 7 Days
...
<?php
$query3=mysqli_query($con,"select id from tblbook where date(posting_date)>=now() - INTERVAL 30 day");
$last30daysregusers=mysqli_num_rows($query3);
?>

                            <div class="col-xl-3 col-md-6">
                                <div class="card bg-danger text-white mb-4">
                                    <div class="card-body">Utilized Hour in Last 30 Days
