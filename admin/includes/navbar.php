  <nav class="sb-topnav navbar navbar-expand navbar-dark bg-dark">
            ...
            <form class="d-none d-md-inline-block form-inline ms-auto me-0 me-md-3 my-2 my-md-0">
             ...
             <form class="d-none d-md-inline-block form-inline ms-auto me-0 me-md-5 my-5 my-md-0" method="post" action="search-result.php">
                <div class="input-group">
                    <input class="form-control" type="text" placeholder="Search staff name , date and clas" title="Search staff name , date and class" aria-describedby="btnNavbarSearch" name="searchkey" />
